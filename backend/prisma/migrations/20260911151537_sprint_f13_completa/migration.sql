...
-- CreateEnum
CREATE TYPE "TaxRegime" AS ENUM ('SIMPLES_NACIONAL', 'LUCRO_PRESUMIDO', 'LUCRO_REAL', 'MEI', 'DOMESTICAS_CEI', 'OUTROS');
...
-- CreateEnum
CREATE TYPE "StatusEnvio" AS ENUM ('PENDENTE_APROVACAO', 'AGENDADO', 'ENVIANDO', 'ENVIADO', 'FALHOU', 'CANCELADO');

-- CreateEnum
CREATE TYPE "TipoEventoEmail" AS ENUM ('ENVIADO', 'ENTREGUE', 'ABERTO', 'BAIXADO', 'FALHA', 'REENVIO', 'CANCELADO');

-- CreateEnum
CREATE TYPE "StatusArquivoFila" AS ENUM ('DETECTADO', 'CLIENTE_IDENTIFICADO', 'SEM_CLIENTE', 'SEM_EMAIL', 'AGUARDANDO_APROVACAO', 'APROVADO', 'REJEITADO', 'ENVIADO', 'ARQUIVADO', 'ERRO');

-- CreateEnum
CREATE TYPE "TipoDocumentoComunicado" AS ENUM ('DAS', 'DARF', 'ISS', 'FGTS', 'IRPF', 'BALANCETE', 'DRE', 'INFORME_RENDIMENTO', 'E_SOCIAL', 'SPED', 'GENERICO');
...
CREATE TABLE "clients" (
    ...
    "municipalRegistrationDate" TIMESTAMP(3),
    "stateRegistrations" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "isStateExempt" BOOLEAN NOT NULL DEFAULT false,
    "otherIdentifiers" TEXT,
    "phone" TEXT,
    "address" TEXT,
    "addressNumber" TEXT,
    ...
    "clientUntil" TIMESTAMP(3),
    "s3dRegistrationDate" TIMESTAMP(3),
...
CREATE TABLE "email_templates" (
    ...
    "companyId" TEXT NOT NULL,
    "nome" TEXT NOT NULL,
    "tipoDocumento" "TipoDocumentoComunicado" NOT NULL,
...
CREATE TABLE "email_envios" (
    ...
    "status" "StatusEnvio" NOT NULL DEFAULT 'PENDENTE_APROVACAO',
    "setor" TEXT,
    "tentativas" INTEGER NOT NULL DEFAULT 0,
    "ultimoErro" TEXT,
    "proximoRetryEm" TIMESTAMP(3),
    "tokenDownload" TEXT NOT NULL,
    "linkExpiraEm" TIMESTAMP(3),
    "aprovadoPor" TEXT,
    "aprovadoEm" TIMESTAMP(3),
    "enviadoPor" TEXT,
    "enviadoEm" TIMESTAMP(3),
    "primeiraAberturaEm" TIMESTAMP(3),
    "primeiroDownloadEm" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "arquivos_fila" (
    ...
    "mime" TEXT,
    "cnpjDetectado" VARCHAR(18),
    "confianca" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "clienteId" TEXT,
    "clienteEmail" TEXT,
    "tipoDocumento" "TipoDocumentoComunicado",
    "competencia" TEXT,
    "status" "StatusArquivoFila" NOT NULL DEFAULT 'DETECTADO',
    "motivoRejeicao" TEXT,
    "erro" TEXT,
    "envioId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "arquivos_fila_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "client_department_owners" (
    "id" TEXT NOT NULL,
    "companyId" TEXT NOT NULL,
    "clientId" TEXT NOT NULL,
    ...
    CONSTRAINT "client_department_owners_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "clients_s3dId_key" ON "clients"("s3dId");
...
-- CreateIndex
CREATE INDEX "email_templates_companyId_ativo_idx" ON "email_templates"("companyId", "ativo");

-- CreateIndex
CREATE UNIQUE INDEX "email_templates_companyId_tipoDocumento_key" ON "email_templates"("companyId", "tipoDocumento");

-- CreateIndex
CREATE UNIQUE INDEX "email_envios_tokenDownload_key" ON "email_envios"("tokenDownload");

-- CreateIndex
CREATE INDEX "email_envios_companyId_status_idx" ON "email_envios"("companyId", "status");

-- CreateIndex
CREATE INDEX "email_envios_companyId_createdAt_idx" ON "email_envios"("companyId", "createdAt");

-- CreateIndex
CREATE INDEX "email_envios_companyId_clienteId_idx" ON "email_envios"("companyId", "clienteId");

-- CreateIndex
CREATE INDEX "email_envios_setor_idx" ON "email_envios"("setor");

-- CreateIndex
CREATE INDEX "email_envios_tokenDownload_idx" ON "email_envios"("tokenDownload");

-- CreateIndex
CREATE INDEX "email_envios_proximoRetryEm_idx" ON "email_envios"("proximoRetryEm");

-- CreateIndex
CREATE INDEX "email_eventos_envioId_createdAt_idx" ON "email_eventos"("envioId", "createdAt");

-- CreateIndex
CREATE INDEX "email_eventos_tipo_createdAt_idx" ON "email_eventos"("tipo", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "arquivos_fila_caminhoAbsoluto_key" ON "arquivos_fila"("caminhoAbsoluto");

-- CreateIndex
CREATE INDEX "arquivos_fila_companyId_status_idx" ON "arquivos_fila"("companyId", "status");

-- CreateIndex
CREATE INDEX "arquivos_fila_companyId_createdAt_idx" ON "arquivos_fila"("companyId", "createdAt");

-- CreateIndex
CREATE INDEX "arquivos_fila_clienteId_idx" ON "arquivos_fila"("clienteId");

-- CreateIndex
CREATE INDEX "arquivos_fila_cnpjDetectado_idx" ON "arquivos_fila"("cnpjDetectado");

-- CreateIndex
CREATE INDEX "client_contacts_companyId_clientId_idx" ON "client_contacts"("companyId", "clientId");

-- CreateIndex
CREATE INDEX "client_department_owners_companyId_clientId_idx" ON "client_department_owners"("companyId", "clientId");

-- CreateIndex
CREATE UNIQUE INDEX "client_department_owners_companyId_clientId_department_key" ON "client_department_owners"("companyId", "clientId", "department");
...
-- AddForeignKey
ALTER TABLE "email_envios" ADD CONSTRAINT "email_envios_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "email_envios" ADD CONSTRAINT "email_envios_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "email_templates"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "email_eventos" ADD CONSTRAINT "email_eventos_envioId_fkey" FOREIGN KEY ("envioId") REFERENCES "email_envios"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "arquivos_fila" ADD CONSTRAINT "arquivos_fila_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "client_department_owners" ADD CONSTRAINT "client_department_owners_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE CASCADE;
