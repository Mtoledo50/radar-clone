...
export default function EnviosPage() {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800 mb-2">📬 Envios & Tracking</h1>
      <p className="text-gray-500 mb-6">Funil completo de comunicações em tempo real</p>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          ...
          <span className="text-sm text-gray-500">Últimos {total} registros</span>
        </div>
              ...
              {envios.map((envio) => (
                <tr key={envio.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 capitalize">
                    {envio.canal === 'whatsapp' ? '📱 ' : envio.canal === 'instagram' ? '📸 ' : ' '}
                    {envio.canal}
                  </td>
